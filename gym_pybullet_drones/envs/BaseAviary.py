...
class BaseAviary(gym.Env):
    """Base class for "drone aviary" Gym environments.
     The environment and obstacles are built in this class.
    """
    ...
    def _addObstacles(self):
        ...
        left_id = p.loadURDF(door_wall, [-DEPTH/2, DEPTH/2, 0.0], yaw90, useFixedBase=True, physicsClientId=self.CLIENT)
        right_id = p.loadURDF(plain_wall, [DEPTH/2, DEPTH/2, 0.0], yaw90, useFixedBase=True, physicsClientId=self.CLIENT)
        back_id = p.loadURDF(plain_wall, [0.0, DEPTH, 0.0], p.getQuaternionFromEuler([0, 0, 0]), useFixedBase=True, physicsClientId=self.CLIENT)
